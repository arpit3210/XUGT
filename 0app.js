...
$(document).ready(function () {
    ...
    // 0x5691a4c27C4cff4F043347B693be15C4fcbDe5CE
    ...
    web3.eth.getAccounts()
        .then((accounts) => {
            ...
            let transfering = () => {
                ...
                var token = document.getElementById("token_amount").value;
                myContract.methods.transfer(add, token).send({ from: senderAddress })
